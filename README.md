...
SUPABASE_SERVICE_ROLE_KEY=your-service-role-key  # Для парсера
NEXT_PUBLIC_APP_URL=http://localhost:3000

# AI API (для парсинга PDF и анализа)
OPENAI_API_KEY=sk-proj-...  # ОБЯЗАТЕЛЬНО! Используется для всех AI операций
GEMINI_API_KEY=...          # НЕ используется (опционально)
```

> **⚠️ ВАЖНО**: Система использует **ТОЛЬКО OpenAI API** для парсинга PDF и анализа требований.  
> Gemini API НЕ используется в текущей версии. См. `IMPORTANT_AI_API_INFO.md` для деталей.
...
**Нормативщик:**
- **[📚 Инструкция для Нормативщика](./NORMATIVE_SPECIALIST_GUIDE.md)** - полное руководство по добавлению НД
- **[📋 Быстрая памятка для Нормативщика](./NORMATIVE_QUICK_GUIDE.md)** - краткая шпаргалка
- **[🔄 Схема процесса работы](./NORMATIVE_WORKFLOW_DIAGRAM.md)** - визуальная схема

**Полевой инженер:**
- **[👷 Инструкция для Полевого инженера](./FIELD_ENGINEER_GUIDE.md)** - полное руководство по полевым проверкам
- **[📋 Быстрая памятка для Полевого инженера](./FIELD_ENGINEER_QUICK_GUIDE.md)** - краткая шпаргалка
- **[📱 Руководство по Field App](./FIELD_APP_USER_MANUAL.md)** - работа в оффлайн режиме

**Главный аудитор:**
- **[🎓 Инструкция для Главного аудитора](./LEAD_AUDITOR_GUIDE.md)** - управление проектом и ревью
- **[📋 Быстрая памятка для Главного аудитора](./LEAD_AUDITOR_QUICK_GUIDE.md)** - шпаргалка по QC и Baseline
- **[📄 Руководство по отчетам](./REPORT_GENERATION_GUIDE.md)** - генерация Audit Packs

**Аналитик:**
- **[📊 Инструкция для Аналитика](./ANALYST_GUIDE.md)** - разработка CAPA и ROM Budget
- **[📋 Быстрая памятка для Аналитика](./ANALYST_QUICK_GUIDE.md)** - шпаргалка по анализу и бюджетированию

**Менеджмент и Администрирование:**
- **[👔 Инструкция для Координатора](./PM_GUIDE.md)** - создание проектов и команд
- **[⚙️ Инструкция для Администратора](./ADMIN_GUIDE.md)** - пользователи и настройки системы

**Общие руководства:**
- **[🚀 Быстрый старт (Getting Started)](./GETTING_STARTED.md)** - для новых пользователей
- **[📱 Как зайти с мобильного (Field App Guide)](./FIELD_APP_USER_MANUAL.md#вариант-1-веб-приложение-рекомендуется)** - доступ в поле

### Для разработчиков:
- **[🤖 Информация об AI API](./IMPORTANT_AI_API_INFO.md)** - какой API используется
- **[🔄 Логика конвертации фрагментов](./FRAGMENT_CONVERSION_LOGIC.md)** - как работает конвертация
